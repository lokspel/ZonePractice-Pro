...
public class HideSpectatorsInvItem extends InvItem {

    public HideSpectatorsInvItem() {
        super(getItemStack("SPECTATOR.MATCH.NORMAL.HIDE-SPECTATORS.ITEM"), getInt("SPECTATOR.MATCH.NORMAL.HIDE-SPECTATORS.SLOT"));
    }
